  ...
  <aside :class="`${is_expanded ? 'is-expanded' : ''}`">
    ...
    <div class="menu">
      <div class="button" @click="toggleDarkMode">
        <span v-if="darkMode == false" class="material-symbols-outlined" style="color: gold;">
          light_mode
        </span>
        <span v-else class="material-symbols-outlined" style="color: gold;"> dark_mode </span>
...
const toggleDarkMode = () => {
  ...
  // Update CSS variables based on darkMode
  if (darkMode.value) {
    document.documentElement.style.setProperty("--primary", "#2ecc71"); // Green
    document.documentElement.style.setProperty("--primary-alt", "#27ae60"); // Dark Green
    document.documentElement.style.setProperty("--grey", "#95a5a6"); // Light Grey
    document.documentElement.style.setProperty("--dark", "#34495e"); // Dark Blue
    document.documentElement.style.setProperty("--dark-alt", "#2c3e50"); // Darker Blue
    document.documentElement.style.setProperty("--light", "#ecf0f1"); // Light Grey
  } else {
    // Reset to your light mode colors
    document.documentElement.style.setProperty("--primary", "#4ade80");
    document.documentElement.style.setProperty("--primary-alt", "#22c55e");
    document.documentElement.style.setProperty("--grey", "#64748b");
